...
import PaginatedLigi from "../component/paginacionLigi";
import useDataFetch from "../ajax/fetch";

export default function Ligi(params) {
    const [isLoaded, error, items] = useDataFetch({url:'competitions/'});
            ...
            <Container className="ligi_box">
                ...
                <div className=" ligi_content flex">
                    {error ? (
                        ...
                        <>
                            <PaginatedLigi
                                items={filterMass({mass:items.competitions, value:filter}) }
                                itemsPerPage={9}
                            />
                        </>
                    )}
