  ...
  return (
    <div className="mt-5 flex flex-col gap-6">
      <PageHero
        ...
        lead="Гость видит витрину. После регистрации — статусы, ЧС, переписка, заявки и справки. Бизнес и специалист с тарифом (ориентир 5–15 тыс. ₽) — лиды и доска. Комиссия со сделок — модель платформы, не банк."
        actions={
          <>
            <Link
              href="/cabinet"
